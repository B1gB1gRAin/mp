...
import com.bigbigrain.mp4.beans.Employee;
import com.bigbigrain.mp4.mapper.EmployeeMapper;

public class MpTest {
	
	ApplicationContext ctx  = new ClassPathXmlApplicationContext("mp4/applicationContext.xml");
